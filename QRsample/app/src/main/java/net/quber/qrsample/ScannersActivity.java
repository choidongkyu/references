...
import net.quber.external.zebra.adapters.AvailableScannerListAdapter;
import net.quber.external.zebra.helpers.AvailableScanner;
...
public class ScannersActivity extends BaseActivity implements ScannerAppEngine.IScannerAppEngineDevListDelegate {
    ...
    private final Handler UpdateScannersHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if(/*false && */lastConnectedScannerList.size()>0){
...
/*
    ...
    public void onBackPressed() {
        if(Application.isAnyScannerConnected){
            ...
            if(launchFromFCS){
                Log.d("dongkyu","startActivity HomeActivity");

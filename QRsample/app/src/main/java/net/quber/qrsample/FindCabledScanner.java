...
import net.quber.external.zebra.helpers.CustomProgressDialog;
...
public class FindCabledScanner extends BaseActivity implements ScannerAppEngine.IScannerAppEngineDevListDelegate,
    ...
    public static ArrayList<DCSScannerInfo> mSNAPIList=new ArrayList<DCSScannerInfo>();
    Dialog dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG,"FindCabledScanner onCreate");
        ...
        for(DCSScannerInfo device:getActualScannersList()){
            if(device.getConnectionType() == DCSSDKDefs.DCSSDK_CONN_TYPES.DCSSDK_CONNTYPE_USB_SNAPI){
                ...
                Log.d(TAG,"mSNAPIList.add("+device+")");
            }
        }
    ...
    protected void onResume() {
        super.onResume();
        Log.d(TAG,"FindCabledScanner onResume");
    ...
    private class MyAsyncTask extends AsyncTask<Void, DCSScannerInfo,Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            if(!isFinishing()) {
                progressDialog = new CustomProgressDialog(FindCabledScanner.this, "werwerwerConnecting To scanner. Please Wait...");
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            if(result== DCSSDKDefs.DCSSDK_RESULT.DCSSDK_RESULT_SUCCESS){
                Log.d(TAG,"FindCabledScanner doInBackground return = true");
                return true;
            }
            else {
                Log.d(TAG,"FindCabledScanner doInBackground return = false");
                return false;
            }
        }

...
import static net.quber.external.zebra.helpers.Constants.DEBUG_TYPE.TYPE_DEBUG;
import static net.quber.external.zebra.helpers.Constants.logAsMessage;

public class BaseActivity extends AppCompatActivity implements ScannerAppEngine, IDcsSdkApiDelegate {

    protected static String TAG = "QRsample";

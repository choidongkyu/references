package net.quber.external.zebra.receivers;
...
import net.quber.qrsample.ActiveScannerActivity;
import net.quber.qrsample.Application;
import net.quber.qrsample.R;
import net.quber.qrsample.ScannersActivity;
